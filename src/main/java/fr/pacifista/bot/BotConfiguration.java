...
public class BotConfiguration {
    ...
    private void checkConfig() throws IOException {
        ...
        if (this.discordToken == null) {
            System.out.print(ConsoleColors.GREEN + "Veuillez entrer le token du bot discord: " + ConsoleColors.RESET);
        ...
        if (this.logID == null) {
            System.out.print(ConsoleColors.GREEN + "Channel id de log: " + ConsoleColors.RESET);
            this.logID = scanner.nextLine();
        }
        if (this.pacifistaChatID == null) {
            System.out.print(ConsoleColors.GREEN + "Channel id du chat pacifista: " + ConsoleColors.RESET);
            this.pacifistaChatID = scanner.nextLine();
        }
        if (this.playerID == null) {
            System.out.print(ConsoleColors.GREEN + "Group id du grade joueur: " + ConsoleColors.RESET);
            this.playerID = scanner.nextLine();
        }
        if (this.adminID == null) {
            System.out.print(ConsoleColors.GREEN + "Group id du grade admin: " + ConsoleColors.RESET);
            this.adminID = scanner.nextLine();
        }
        if (this.pacifistaAddress == null) {
            System.out.print(ConsoleColors.GREEN + "Adresse du socket du serveur minecraft: " + ConsoleColors.RESET);
            this.pacifistaAddress = scanner.nextLine();
        }
        if (this.pacifistaPort == 0) {
            System.out.print(ConsoleColors.GREEN + "Port du socket du serveur minecraft: " + ConsoleColors.WHITE);
